...
@section('main_content')
    ...
    <div>
        <button type="submit" name="sendme" value="1" class="btn btn-lg btn-primary">Принять</button>
</div>
</form>
@endsection